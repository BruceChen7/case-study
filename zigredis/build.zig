...
pub fn build(b: *std.Build) void {
    ...
    const run_unit_tests = b.addRunArtifact(req_unit_tests);
    const run_rsp_unit_tests = b.addRunArtifact(rsp_unit_tests);
    ...
    test_step.dependOn(&run_rsp_unit_tests.step);
}
